...
- ソフトウェアサプライチェーンセキュリティ (SBOM、アーティファクトの署名と来歴、CI/CD パイプラインセキュリティ)
...
- [1-要員 (People)](current-version/1-People)
  ...
  - [1-2-トレーニング (Training)](current-version/1-People/1-2-Training)
    ...
    - [1-2-3-セキュリティ文化と意識 (Security-culture-and-awareness)](current-version/1-People/1-2-Training/1-2-3-Security-culture-and-awareness.md)
- [2-プロセス (Process)](current-version/2-Process)
  - [2-1-設計 (Design)](current-version/2-Process/2-1-Design)
    ...
    - [2-1-2-セキュアな設計と要件 (Secure-design-and-requirements)](current-version/2-Process/2-1-Design/2-1-2-Secure-design-and-requirements.md)
  ...
  - [2-3-ビルド (Build)](current-version/2-Process/2-3-Build)
    ...
    - [2-3-4-Infrastructure as Code セキュリティ (Infrastructure-as-Code-Security)](current-version/2-Process/2-3-Build/2-3-4-Infrastructure-as-Code-Security)
      - [2-3-4-1-Infrastructure as Code スキャン (Infrastructure-as-Code-Scanning)](current-version/2-Process/2-3-Build/2-3-4-Infrastructure-as-Code-Security/2-3-4-1-Infrastructure-as-Code-Scanning.md)
    - [2-3-5-セキュリティゲート (Security-Gates)](current-version/2-Process/2-3-Build/2-3-5-Security-Gates.md)
    - [2-3-6-サプライチェーンセキュリティ (Supply-Chain-Security)](current-version/2-Process/2-3-Build/2-3-6-Supply-Chain-Security)
      - [2-3-6-1-SBOM (SBOM)](current-version/2-Process/2-3-Build/2-3-6-Supply-Chain-Security/2-3-6-1-SBOM.md)
      - [2-3-6-2-アーティファクトの署名と来歴 (Artifact-Signing-and-Provenance)](current-version/2-Process/2-3-Build/2-3-6-Supply-Chain-Security/2-3-6-2-Artifact-Signing-and-Provenance.md)
      - [2-3-6-3-CICD パイプラインセキュリティ (CICD-Pipeline-Security)](current-version/2-Process/2-3-Build/2-3-6-Supply-Chain-Security/2-3-6-3-CICD-Pipeline-Security.md)
